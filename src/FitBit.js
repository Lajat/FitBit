...
class AmazonFitBit extends Component {
    ...
    onTimeClicked = () => {
        // document.getElementsByClassName('classes.timebtn').style.zIndex = "500";
        ...
        return(
            <div className={classes.main}>
                ...
                <div className={classes.watchWrapper}>
                   <img className={classes.watch} src="https://i.imgur.com/PTgQlim.png"/>
                   <img className={classes.watch} src="https://i.imgur.com/iOeUBV7.png"/>
                   <img className={classes.watch} src="https://i.imgur.com/Mplj1YR.png"/>
                   <img className={classes.watch} src="https://i.imgur.com/xSIK4M8.png"/>
                </div>
                <div className={classes.contentWrapper}>
                   ...
                   <div className={classes.timeWrapper} >
                       <div className={classes.clock} onload="showTime()"></div>
                   </div>
